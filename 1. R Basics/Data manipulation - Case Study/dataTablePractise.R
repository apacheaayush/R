...
#-----------
    ...
    # Question 2: Understand the data using different functions like View, head, tail, str, names, nrow, ncol, summary, duplicates, describe etc.
      # CODE :-
        ...
        # 8. Duplicate observations in the dataset.
             anyDuplicated(customers, by = "Customer.ID") # Result - 9818. 9818 is the index of the first duplicate, if there would be no duplicates this value would be 0
...
#------------
    ...
    #             - Low Value Segment - less than or equal to 10000.
      # CODE :-
        customers[ , customerValueSegment := ifelse(Customer.Value > 25000, "High Value Segment", ifelse(Customer.Value < 10000, "Low Value Segment", "Medium Value Segment"))]
        View(customers)
